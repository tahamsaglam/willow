...
static unsigned int wlan_sdio_on_table[][4] = {
        ...
        {GPIO_WLAN_SDIO_CD, GPIO_WLAN_SDIO_CD_AF, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE},
...
static unsigned int wlan_sdio_off_table[][4] = {
        ...
        {GPIO_WLAN_SDIO_CMD, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP},
        {GPIO_WLAN_SDIO_CD, 0, GPIO_LEVEL_LOW, S3C_GPIO_PULL_NONE},
        {GPIO_WLAN_SDIO_D0, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP},
        {GPIO_WLAN_SDIO_D1, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP},
        {GPIO_WLAN_SDIO_D2, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP},
        {GPIO_WLAN_SDIO_D3, 0, GPIO_LEVEL_NONE, S3C_GPIO_PULL_UP},
};
